...
region (hundred of bases, see for example XXXmethylseekR paperXXX) and when looking at stretches
of millions of bases (\cite{largeblocks} ).
This brings about contrasting requirements when analyzing this kind of data: a rough
